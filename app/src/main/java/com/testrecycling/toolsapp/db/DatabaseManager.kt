...
object DatabaseManager {
    ...
    private const val DATABASE_PATH = "/data/data/com.testrecycling.toolsapp/databases/"
...
//                    database.execSQL("ALTER TABLE FileEntity ADD COLUMN status INTEGER NOT NULL DEFAULT 0")
            ...
            // 数据库名称
            val newInstance =
                    Room.databaseBuilder(context.applicationContext, SQLDatabase::class.java, DATABASE_NAME).addMigrations(MIGRATION_4_5).addCallback(object : RoomDatabase.Callback() {
