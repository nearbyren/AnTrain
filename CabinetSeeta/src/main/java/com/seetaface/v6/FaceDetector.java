...
import com.seetaface.v6.constant.SeetafaceConst;
...
//        setProperty(SeetafaceConst.PROPERTY_NUMBER_THREADS, 4);

        setProperty(SeetafaceConst.PROPERTY_MIN_FACE_SIZE, FaceConfig.PROPERTY_MIN_FACE_SIZE_VALUE);
        setProperty(SeetafaceConst.PROPERTY_THRESHOLD, FaceConfig.PROPERTY_THRESHOLD_VALUE);
        setProperty(SeetafaceConst.PROPERTY_NUMBER_THREADS, 4);
//        setProperty(SeetafaceConst.PROPERTY_MAX_IMAGE_WIDTH, 1080);
//        setProperty(SeetafaceConst.PROPERTY_MAX_IMAGE_HEIGHT, 1920);

        Log.d(TAG, "face--- default_max_width:" + getDetectorProperty(SeetafaceConst.PROPERTY_MAX_IMAGE_WIDTH));
        Log.d(TAG, "face--- default_max_height:" + getDetectorProperty(SeetafaceConst.PROPERTY_MAX_IMAGE_HEIGHT));
    }

    public void destroy() {
        int result = nativeDestroyEngine();
        Log.d(TAG, "face--- destroyEngine result:" + result);
    }
